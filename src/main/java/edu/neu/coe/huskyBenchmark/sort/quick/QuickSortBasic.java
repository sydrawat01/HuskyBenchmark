...
public class QuickSortBasic<X extends Comparable<X>> extends QuickSort<X> {

    public static final String DESCRIPTION = "QuickSort basic";

    public QuickSortBasic(String description, int N, Config config) {
     ...
     */
    public QuickSortBasic(ComparisonSortHelper<X> helper) {
        super(helper);
        setPartitioner(createPartitioner());
    }
     ...
     */
    public QuickSortBasic(int N, Config config) {
     ...
     * @param config the configuration.
     */
    public QuickSortBasic(Config config) {
        this(0, config);
    }
